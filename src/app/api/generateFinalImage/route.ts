...
export async function POST(request: NextRequest) {
  try {
    ...
    // Step 1: Get place description from coordinates (if available)
    let placeDescription = "this location";
    if (body.lat !== 0 && body.lng !== 0) {
      ...
      console.log("No coordinates provided, using default place description");
    }
